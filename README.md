...
<br><br>
- 문제 정의
LLM의 운영 비용 문제가 커지면서 쿼리에 적합한 모델을 선택하는 라우팅 연구가 활발히 진행되고 있습니다. 그러나 기존 연구들은 응답 품질을 0/1 이진 레이블로만 학습하여 응답의 완성도·정확성·적절성의 차이를 반영하지 못하며, 결과적으로 비용 제약 환경에서 최적이 아닌 모델을 선택하는 문제가 발생합니다. 본 연구는 쿼리 특성과 LLM 특성을 모두 고려한 상황별 라우팅을 통해 비용 대비 성능을 최적화하는 것이 핵심 목표입니다.
