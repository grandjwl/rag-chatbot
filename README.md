...
## 검색 증강 생성 기반 챗봇 설계 및 구현

# 🤖 BizAI — LLM/RAG 기반 기업 AI 비서

> 전자부품 유통사를 위한 업무형 AI 챗봇 서비스
> 자연어 질문만으로 재고·매출·매입 데이터를 즉시 조회하고 인사이트를 제공합니다.

<!-- 이미지: BizAI 로고 또는 챗봇 메인 화면 스크린샷 (PPT 22페이지) -->
